 ...
 */
module pspsdk.pspiofilemgr;

public import pspsdk.pspkerneltypes;
public import pspsdk.pspiofilemgr_fcntl;
public import pspsdk.pspiofilemgr_stat;
public import pspsdk.pspiofilemgr_dirent;
 ...
 */
SceUID sceIoOpen(byte *file, int flags, SceMode mode);
 ...
 * @return A non-negative integer is a valid fd, anything else an error
 */
SceUID sceIoOpenAsync(byte *file, int flags, SceMode mode);
 ...
 */
int sceIoMkdir(byte *dir, SceMode mode);
 ...
 * @return < 0 on error.
 */
int sceIoRename(byte *oldname, byte *newname);
...
/**
  ...
  */
SceUID sceIoDopen(byte *dirname);
...
/** 
  ...
  */
int sceIoDevctl(byte *dev, uint cmd, void *indata, int inlen, void *outdata, int outlen);
...
/** 
  ...
  * 
  */
int sceIoAssign(byte *dev1, byte *dev2, byte *dev3, int mode, void* unk1, int unk2);
...
/** 
  ...
  * @return < 0 on error.
  */
int sceIoGetstat(byte *file, SceIoStat *stat);
...
/** 
  ...
  * @return < 0 on error.
  */
int sceIoChstat(byte *file, SceIoStat *stat, int bits);
...
/**
  ...
  * @return 0 on success, < 0 on error
  */
int sceIoIoctlAsync(SceUID fd, uint cmd, void *indata, int inlen, void *outdata, int outlen);
...
/**
  ...
  * @param unk - Unknown
  */
int sceIoSync(byte *device, uint unk);
