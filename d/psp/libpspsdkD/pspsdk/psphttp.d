 ...
 */
int sceHttpCreateConnection(int templateid, char *host, char *unknown1, ushort port, int unknown2);
 ...
 * @returns A connection ID on success, < 0 on error.
 */
int sceHttpCreateConnectionWithURL(int templateid, char *url, int unknown1);
 ...
 * @returns 0 on success, < 0 on error.
 */
int sceHttpSendRequest(int requestid, void *data, uint datasize);
 ...
 */
int sceHttpReadData(int requestid, void *data, uint datasize);
 ...
 * @returns 0 on success, < 0 on error.
 */
int sceHttpSetResolveTimeOut(int id, uint timeout);
 ...
 * @returns 0 on success, < 0 on error.
 */
int sceHttpSetConnectTimeOut(int id, uint timeout);
 ...
 * @returns 0 on success, < 0 on error.
 */
int sceHttpSetSendTimeOut(int id, uint timeout);
 ...
 * @returns 0 on success, < 0 on error.
 */
int sceHttpSetRecvTimeOut(int id, uint timeout);
 ...
 * @returns 0 on success, < 0 on error.
 */
int sceHttpDeleteHeader(int id, char *name);
