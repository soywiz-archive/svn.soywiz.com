...
const int PSP_MEMORY_PARTITION_KERNEL = 1;
const int PSP_MEMORY_PARTITION_USER = 2;
...
/**
  ...
  */
SceUID sceKernelLoadModule(byte *path, int flags, SceKernelLMOption *option);
...
/**
  ...
  * @returns The UID of the loaded module on success, otherwise one of ::PspKernelErrorCodes.
  */
SceUID sceKernelLoadModuleMs(byte *path, int flags, SceKernelLMOption *option);
