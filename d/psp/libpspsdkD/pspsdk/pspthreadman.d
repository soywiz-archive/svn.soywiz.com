...
// alias THREAD_ATTR_VFPU PSP_THREAD_ATTR_VFPU;
// alias THREAD_ATTR_USER PSP_THREAD_ATTR_USER;
 ...
 */
SceUID sceKernelCreateThread(char *name, SceKernelThreadEntry entry, int initPriority,
 ...
 */
SceUID sceKernelCreateSema(char *name, SceUInt attr, int initVal, int maxVal, SceKernelSemaOptParam *option);
...
/** 
  ...
  * @endcode
  */
SceUID sceKernelCreateEventFlag(char *name, int attr, int bits, SceKernelEventFlagOptParam *opt);
 ...
 */
SceUID sceKernelCreateMbx(char *name, SceUInt attr, SceKernelMbxOptParam *option);
 ...
 */
int sceKernelCreateCallback(char *name, SceKernelCallbackFunction func, void *arg);
 ...
 */
SceUID sceKernelCreateMsgPipe(char *name, int part, int attr, void *unk1, void *opt);
 ...
 */
SceUID sceKernelCreateVpl(char *name, int part, int attr, uint size, SceKernelVplOptParam *opt);
 ...
 * @return The UID of the created pool, < 0 on error.
 */
int sceKernelCreateFpl(char *name, int part, int attr, uint size, uint blocks, SceKernelFplOptParam *opt);
 ...
 */
SceUID sceKernelCreateVTimer(char *name, SceKernelVTimerOptParam *opt);
 ...
 */
SceUID sceKernelRegisterThreadEventHandler(char *name, SceUID threadID, int mask, SceKernelThreadEventHandler handler, void *common);
